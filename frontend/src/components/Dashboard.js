...
const Dashboard = () => {
  ...
  const menuItems = [
    {
      label: "Employees",
      options: ["Add Employee", "Hire Employee", "Fire Employee"],
    },
    {
      label: "Owners/Businesses",
      options: ["Add Owner", "Add Business", "Add Location", "Start Funding"],
    },
    {
      label: "Vans",
      options: [
    ...
    {
      label: "Products",
      options: ["Add Product", "Purchase Product", "Remove Product"],
    },
    {
      label: "Views",
      options: [
